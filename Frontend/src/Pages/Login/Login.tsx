...
const Login = () => {
  ...
  return (
    <div className="flex items-center bg-[#cecece] justify-center h-screen">
      <form className="bg-white w-[30%] h-[58vh] rounded-2xl p-4">
        ...
        <div className="grid mt-12 ml-4 ">
          ...
          <input
            ...
            className="bg-gray-50 border mt-2 border-gray-300 text-gray-900 text-xs rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
          />
        </div>
        ...
        <button className="w-[96%] py-1.5 rounded font-bold hover:scale-95 duration-500 transition-all text-sm ml-4 mt-4 bg-slate-700 text-white" onClick={handleSubmit}>
          Login
        </button>
